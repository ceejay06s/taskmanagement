...
<div class="container-fluid">
    <div class="fixed-action-btn ">
        <a class="btn-floating btn-large blue-grey lighten-1 tooltipped" href="/addtodo" data-position="left" data-tooltip="Add Task">
    ...
    <div class="row justify-content-center">
            ...
            <ul class="collapsible popout" style="max-height: 500px; background: white; overflow: auto;">
                ...
                <li>
                    ...
                    <div class="collapsible-body collapsible-body_custom " style="padding-top: 0px !important;">
                        ...
                        <hr>
                        <a class="btn-floating small right blue-grey lighten-1 wave-effect tooltipped" href="/edittodo/{{$Task_Item->id}}{{($Task_Item->parent_id?'/'.$Task_Item->parent_id:'')}}" data-position="left" data-tooltip="Edit Task">
            ...
            <ul class="collapsible popout" style="max-height: 500px; background: white; overflow: auto;">
                ...
                <li>
                    ...
                    <div class="collapsible-body collapsible-body_custom " style="padding-top: 0px !important;">
                        ...
                        <div class="truncate">{{$Task_Item->description}}</div>
                        <hr>
                        <a class="btn-floating small right blue-grey lighten-1 wave-effect tooltipped" href="/edittodo/{{$Task_Item->id}}" data-position="left" data-tooltip="Edit Task">
                            <i class="material-icons">mode_edit</i>
                        </a>
                        <div>
                            @if($Task_Item->count)
        ...
        <div class="col s12 l4">
            ...
            @if(isset($task[3]))
            <ul class="collapsible popout" style="max-height: 500px; background: white; overflow: auto;">
                @foreach($task[3] as $Task_Item)
                <li>
                    <blockquote class="collapsible-header" style="border-color: green; border-bottom: 0px;">
                        {{$Task_Item->title}}
                    </blockquote>
                    <div class="collapsible-body collapsible-body_custom " style="padding-top: 0px !important;">
                        <div class="truncate">{{$Task_Item->description}}</div>
